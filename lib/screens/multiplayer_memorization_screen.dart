...
class MultiplayerMemorizationScreen extends StatefulWidget {
  ...
  @override
  State<MultiplayerMemorizationScreen> createState() =>
      _MultiplayerMemorizationScreenState();
}

class _MultiplayerMemorizationScreenState
    ...
    if (_selectedCards.length < 2) {
      ...
      if (gameState != null) {
        ...
        final availableIndices =
            List.generate(humanPlayer.hand.length, (i) => i)
  ...
  Widget build(BuildContext context) {
    // Note: We use MultiplayerGameProvider here
    final gameState = context.watch<MultiplayerGameProvider>().gameState;
    ...
    // Find the HUMAN player (the local user)
    final provider = context.read<MultiplayerGameProvider>();
    final humanPlayer =
                          ...
                          return Center(
                            child: Padding(
                              ...
                              child: Wrap(
                                ...
                                spacing: spacing,
                                runSpacing: spacing,
                                children: List.generate(humanPlayer.hand.length,
                                    (index) {
                                  final isSelected =
