...
import 'package:dutch_game/widgets/game/player_area_builders.dart' as builders;
...
mixin GameLayoutMixin<T extends StatefulWidget> on State<T> {
  ...
  Widget buildPlayerBlock({
    ...
    final handWidget = PlayerHandWidget(
      ...
      isPowerHighlighted: isPowerHighlighted,
  ...
  Widget buildPlayerAreaWithButtons({
    ...
    if (isCompactMode) {
      return builders.buildCompactPlayerArea(
        context: context,
        isMyTurn: isMyTurn,
        hasDrawn: hasDrawn,
        sideButtonWidth: sideButtonWidth,
    ...
    return builders.buildNormalPlayerArea(
      isMyTurn: isMyTurn,
      hasDrawn: hasDrawn,
      sideButtonWidth: sideButtonWidth,
      actionButtonHeight: actionButtonHeight,
