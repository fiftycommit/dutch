...
// Il ne doit pas y avoir de double hôte : un seul hostPlayerId, pointant vers un
// joueur connecté et unique.
test('bug#2.3: créateur qui revient après transfert -> un seul hôte cohérent (pas de double)', (t) => {
